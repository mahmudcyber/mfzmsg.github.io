    ...
    <section id="services" class="services  section-bg ">
        <div class="container">
            ...
            <div class="row">
                ...
                <p style="text-align: justify">	To serve as an effective and efficient 
                  machinery in the sourcing, controlling and disbursement of Zamfara State
                   Government financial resources, to enhance the living standard of the State 
                   residents using a committed workforce.
				        </p>
                </div>
            </div>
        </div>
