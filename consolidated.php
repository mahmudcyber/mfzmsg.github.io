    ...
    <section id="services" class="services  section-bg ">
        <div class="container">
            <div class="section-title pt-5" data-aos="fade-left">
                <h2>Consolidated Account Department</h2>
            </div>
            <div class="row">
                <div class="col-lg-12">
                <p>
						Consolidated Account Department is a department under the Accountant General Ofiice responsible for the safe 
						keeping of all vouchers and other financial documents in the voucher store. Other responsibilities of the department include:
					</p>
					<ul class="ml-4">
						<li> Preparations of the State Government Final Accounts refers to as Accountant General Report on timely basis 
							and in conformity with existing laws, provision of international standard and best practice subscribed by the 
							Federal Government and the State.
						</li>
						<li>
							Integrating the process of Computerized System for all the MDAs.
						</li>
						<li>
							Liaises with MDAs in ensuring that the Financial and Accounting Standard and Regulations are adhered to in 
							preparation of their Financial Reports/Returns to the Ministry of Finance.
						</li>
						<li>
							The department corresponds with the Federal Government, Donor Agencies in various aspects of data collection, tax audit, etc.
						</li>
						<li>
							Serves as the secretariat of general Financial Reforms, such as International Public Sector Accounting Standard (IPSAS), 
							SFTAS, and others.
						</li>
