    ...
    <section id="services" class="services  section-bg ">
        <div class="container">
            <div class="section-title pt-5" data-aos="fade-left">
                <h2>Funds Management Department</h2>
            </div>
            <div class="row">
                <div class="col-lg-12">
                <p>
						Funds Management department is a department under Accountant General Office responsible for all Receipts and Payments with the following 
						activities:</p>
					<ol class="ml-4">
						<li>Source foreign exchange for overseas medical treatment, foreign students and
							Government Officials on trip.</li>
						<li>Preparation of cash flow information to aid management decision.</li>
						<li>Provision of financial data to Revenue Mobilization Allocation and Fiscal Commission, 
							Central Bank of Nigeria, Commercial Banks, etc.</li>
						<li>Prepares remittance vouchers to Sub-Treasury.</li>
						<li>Preparations of remittances of tax deductions to Federal Inland Revenue Service, 
							Board of Internal Revenue, Finance Incorporated departments, Poverty Alleviation and Zakkat Board, etc.
                        </li>
					</ol>
                </div>
            </div>
