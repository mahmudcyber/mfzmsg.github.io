    ...
    <section id="services" class="services  section-bg ">
        <div class="container">
            ...
            <div class="row">
                ...
                <p style="text-align: justify">Our mission is to formulate and implement dynamic fiscal policy and strengthen public financial management (PFM)
						for effective resource mobilization, efficient allocation, prudent expenditure, and debt 
						management with proper accountability of public resources across the state. In addition, 
						to sustain economic growth with stable macroeconomic environment through dynamic fiscal policy 
